...
function loadGoogleSheetData() {
    ...
    const spreadsheetId = '1fGVpC4djqBJFV32RzyL6Vuzs-pODD0fYKb4QOGQt_40';
    // ID da planilha dentro do documento (geralmente 0 para a primeira planilha)
    const sheetId = 0;

    gapi.client.sheets.spreadsheets.values.get({
        spreadsheetId: spreadsheetId,
        range: 'testes' // Substitua pelo nome da aba que você deseja ler
...
function initGoogleSheetsApi() {
    gapi.client.init({
        apiKey: 'AIzaSyCIbXDHm8SEJiIXyP__Z2AjXwew2XA4oi4',
